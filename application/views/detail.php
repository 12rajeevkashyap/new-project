...
<a class="active" href="<?php echo base_url('listing');?>" style="color:white;"><i class="fa fa-arrow-circle-right" style="font-size:20px"></i>&nbsp; <i class="fa fa-file" aria-hidden="true"></i>&nbsp;Listing</a>
...
<a href="<?php echo base_url();?>file_listing?id=<?php echo $row->id;?>">File Link</a>
</td>
...
<td>
<button type="button"  del="<?php echo $row->id;?>"   name="btn_delete" id="delete1" class=" Remove btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</button>
</td>
</tr>
</tbody>
<?php 
...
{
var remove=$(this).attr("del");

alert(remove);

}
$.post("<?php echo base_url();?>Welcome/delete1",{remove:remove},function(res)
{
...
// if(confirm("you want to delete post"))
// {
// var remove1=$(this).attr("del1");

// alert(remove1);

// }
// $.post("<?php echo base_url();?>Welcome/delete2",{remove1:remove1},function(res)
// {
